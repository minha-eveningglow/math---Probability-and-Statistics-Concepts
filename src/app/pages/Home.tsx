          ...
          <div className="flex items-start flex-1">
            ...
            <div>
              ...
              <p className="text-lg mb-4">
                조합론 → 이항정리 → 파스칼의 삼각형 → 이항분포 → 정규분포 → 정규근사 → 표본평균의 추정
              </p>
              <p className="text-indigo-100 mb-4">
                각 단원들이 왜 이 순서로 배치되었는지 이해하면 공부가 더 쉬워집니다.
                대수학의 조합 계수가 확률의 세계로 이어지고, 다시 확률변수 하나의 분포에서
                표본평균이라는 새로운 확률변수의 분포로, 마침내 모평균을 추정하는 통계적 추론까지
                자연스럽게 연결되는 과정을 시각화하여 확인해보세요.
              </p>
              <Link
                to="/flow"
